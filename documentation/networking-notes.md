...
ANSWER:  If something goes wrong and the VM is connected to your hosts drive then your host files are at risk.  We want to keep the VM completely Isolated.
